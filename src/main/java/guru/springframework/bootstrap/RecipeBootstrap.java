...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes()
    {
        ...
        Optional<UnitOfMeasure> cupOomOptional = unitOfMeasureRepository.findByDescription("Cup");
        if(!cupOomOptional.isPresent())
        {
            throw new RuntimeException("Expected UOM not found");
        }
        ...
        UnitOfMeasure cupsUom = cupOomOptional.get();
        ...
        guacRecipe.setPreptTime(10);
        guacRecipe.setCookTime(0);
        guacRecipe.setServings(4);
        guacRecipe.setDifficulty(Difficulty.EASY);

        guacRecipe.setInstructions("1 Cut avocado, remove flesh: Cut the avocados in half. Remove seed. Score the inside of the avocado with a blunt knife and scoop out the flesh with a spoon" +
                "\n" +
        ...
        tacosRecipe.setPreptTime(20);
        tacosRecipe.setDifficulty(Difficulty.MEDIUM);

        tacosRecipe.setInstructions("1 Prepare a gas or charcoal grill for medium-high, direct heat.\n" +
